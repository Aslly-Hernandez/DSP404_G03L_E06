...
namespace SitioWebCA222101.Models
{
    public class Conexion
    {
        ...
        public Conexion()
        {
            cadenaConexion = @"Data source=DESKTOP-A9EINB3\SQLEXPRESS;Initial Catalog=Bolsa_Trabajo;Integrated Security=True";
        }
        ...
        public int actualizarOferta(int idOferta, int nIdEmpresa, string sTituloOferta, int nTipoJornada, int nTipoContrato, double fSalario, int nIdLocalidad, int nTipoLocalidad, int nIdCategoria, string sDescripcion, string fechaContratacion, int nVacantes)
        {
